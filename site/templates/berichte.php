...
<?php foreach ($years as $year): ?>
    <div class="row">
        ...
        <div class="small-2 columns"><h4 class="text-center"><?= (string)$year ?></h4></div>
        <div class="small-5 columns"><hr /></div>
            ...
            <ul class="small-block-grid-2 medium-block-grid-3 large-block-grid-4">
                <?php foreach ($reports as $report): ?>
                    <li><a href="<?= $report->url() ?>">
                            <div>
                                <img
                                    src="<?= thumb($report->images()->find((string)$report->titelbild()), array('height' => 150, 'width' => 227, 'crop' => true))->url() ?>"/>
                            </div>
